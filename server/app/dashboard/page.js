...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 64644)), "E:\\COSAS\\proyecto\\ampeer\\src\\app\\dashboard\\page.tsx"],
          
        }]
      },
        {
        'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 23909)), "E:\\COSAS\\proyecto\\ampeer\\src\\app\\dashboard\\layout.tsx"],
        metadata: {
    ...
    manifest: undefined
        ...
        {
        'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 74053)), "E:\\COSAS\\proyecto\\ampeer\\src\\app\\layout.tsx"],
...
const pages = ["E:\\COSAS\\proyecto\\ampeer\\src\\app\\dashboard\\page.tsx"];
...
/* harmony import */ var _mui_material_InputLabel__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(97445);
...
/* harmony import */ var _mui_material_FormControl__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(58111);
...
/* harmony import */ var _mui_material_Select__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(51892);
...
/* harmony import */ var _mui_x_date_pickers_DatePicker__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(71026);
/* harmony import */ var _mui_x_date_pickers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(77625);
...
/* harmony import */ var _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(65656);
/* harmony import */ var _mui_icons_material_Search__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(32122);
...
function Page() {
    const startDate = dayjs__WEBPACK_IMPORTED_MODULE_3___default()();
    const endDate = dayjs__WEBPACK_IMPORTED_MODULE_3___default()().add(1, "day");
    const [institutionData, setInstitutionData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [selectedInstitution, setSelectedInstitution] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const [selectedStartDate, setSelectedStartDate] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(startDate);
    const [selectedEndDate, setSelectedEndDate] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(endDate);
    const [balance, setBalance] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(0.00);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        axios__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.get(API_BACKEND + "institutions").then((response)=>{
    ...
    const handleSelectedInstitution = (event)=>{
    ...
    const handleSearchDetails = ()=>{
        ...
        // Fetch data from the API
        axios__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.post(API_BACKEND + "balance", balanceRequest).then((response)=>{
            if (response.status === 200) {
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_x_date_pickers__WEBPACK_IMPORTED_MODULE_5__.LocalizationProvider, {
        dateAdapter: _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_6__/* .AdapterDayjs */ .y,
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("main", {
            className: "min-h-screen flex-col p-24",
                    ...
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_8__.Grid, {
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((_mui_material_FormControl__WEBPACK_IMPORTED_MODULE_9___default()), {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Select__WEBPACK_IMPORTED_MODULE_11___default()), {
                                        labelId: "demo-simple-select-label",
                                        id: "demo-simple-select",
                                        label: "Age",
                                        onChange: handleSelectedInstitution,
                                        value: selectedInstitution,
                                        children: institutionData.map((data)=>{
                                            return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_MenuItem__WEBPACK_IMPORTED_MODULE_12___default()), {
                                                value: data.id,
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_8__.Grid, {
                            ...
                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_8__.IconButton, {
                                ...
                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_icons_material_Search__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z, {
                                    fontSize: "large"
                                })
                            })
                        }),
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_8__.Grid, {
                            item: true,
                            xs: true,
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((_mui_material_Typography__WEBPACK_IMPORTED_MODULE_15___default()), {
                                variant: "h3",
                                color: balance < 0.0 ? "error.main" : "success.main",
                                children: [
                                    "Balance: ",
                                    balance ? USDollar.format(balance) : 0.00
                                ]
                            })
                        })
                    ]
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`E:\COSAS\proyecto\ampeer\src\app\dashboard\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [587,70,104,548], () => (__webpack_exec__(43617)));
