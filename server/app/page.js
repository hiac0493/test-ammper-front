...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 78159)), "E:\\COSAS\\proyecto\\ampeer\\src\\app\\page.tsx"],
          metadata: {
...
const pages = ["E:\\COSAS\\proyecto\\ampeer\\src\\app\\page.tsx"];
...
/* harmony import */ var _mui_material_Grid__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(21971);
...
/* harmony import */ var _mui_material_Paper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(52694);
...
function Home() {
    const Item = (0,_mui_material_styles__WEBPACK_IMPORTED_MODULE_3__.styled)((_mui_material_Paper__WEBPACK_IMPORTED_MODULE_4___default()))(({ theme })=>({
    ...
    const handleLogin = ()=>{
        axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z.post(API_BACKEND + "login", {
            username,
            password
        }).then((response)=>{
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`E:\COSAS\proyecto\ampeer\src\app\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [587,70,548], () => (__webpack_exec__(75039)));
